...
I am a quantum condensed matter theorist currently completing my Ph.D. in Physics at the Indian Institute of Science Education and Research Kolkata under the supervision of *Prof. Siddhartha Lal*. My doctoral research focuses on *strongly correlated quantum matter*, in particular understanding Mott metal–insulator transitions and the emergence of non-Fermi liquid phases through the lens of *Kondo breakdown*. I anticipate that I will be able to join for a postdoc position by *February 2026*.
...
Much of my work has overlap with the research carried out at the Walter Burke Institute for Theoretical Physics, particularly by *Prof. Prof. Bogdan Bernevig*. For example, 
