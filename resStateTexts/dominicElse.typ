...
#balance(
  columns(2, [I am a quantum condensed matter theorist focusing primarily on characterising phases of strongly correlated *quantum matter*. These are novel states that appear at zero temperature and display emergent exotic properties, often driven by strong interactions between the constituent particles. Such phases are interesting because they cannot be described within the paradigm of spontaneous symmetry breaking and local order parameters. Instead, phase transitions involving such phases often involve changes in *topology*.

My work presently focuses on understanding various features of repulsion-driven Mott metal-insulator transitions from the perspective of *Kondo breakdown*. Impurity models (models with a correlated electronic orbital hybridising with a "sea" of non-interacting electrons) involving destruction of magnetic screening often displays quantum criticality, non-Fermi liquid physics and pseudogapped phases. This has allowed us to propose simple impurity models that are able to capture and understand crucial features of Mott transitions, lending valuable insights into this complicated problem. 

One of the most exciting insights that have emerged from this body of work is that correlation-driven transitions can be captured quite effectively through quantum impurity models. Moreover, we have shown that in two dimensional lattice models, such transitions involve changes in the anomaly structure of the Fermi surface, and usually involve an intervening quantum critical phases with long-range entanglement. This resonates well with the work of *Prof. Dominic Else* at Perimeter, who investigates non-perturbative topological properties of quantum liquids. I believe this conceptual overlap opens exciting opportunities for fresh collaborative research in the field of quantum matter, focusing on non-Fermi liquids.
])
)
...
In addition to extending my current work on Mott physics and Kondo breakdown, I envision several near-term projects that overlap with ongoing research at the *quantum matter* group at Perimeter, particularly with the work of *Prof. Dominic Else*.
