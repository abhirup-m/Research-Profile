...
My work is presently focused on understanding various features of Mott metal-insulator transitions from the perspective of *Kondo breakdown*. Impurity models involving destruction of Kondo screening often display quantum criticality, non-Fermi liquid physics and characteristic entanglement signatures, ideas that are in resonance with the recent work of *Prof. Tarun Grover* at UC San Diego. I believe this conceptual overlap opens exciting opportunities for collaborative research, as I explain in more detail below.
]))
...
#balance(
  columns(2, [
  The presence of themes such as non-Fermi liquids, quantum criticality and entanglement in my research lead to considerable overlap with the work of Prof. Tarun Grover. I propose a few projects below that combine our research interests:

*Extending the recent work on "Non-Fermi Liquid to a Spin-Solid in a Multichannel Kondo Lattice"*: In order to allow for more exotic phases, the present work can be extended by introducing electronic interaction in the conduction bath in the form of the exactly solvable Hatsugai-Kohmoto model (which can lead to non-Fermi liquid and pseudogap phases). The destruction of the Fermi liquid quasiparticles in the conduction bath should lead to additional competition to Kondo screening, making things more interesting.
