...
As is clear from the preceding sections, my primary research interest lies in understanding correlation-driven phase transitions, either by applying existing analytical/numerical methods or through the development of new methods. Specific aspects of my interest include emergent non-Fermi liquid phases, orbital/band-selective transitions, topology changes and changes in entanglement patterns, among others. Other topics that I am interested in and look forward to working on in the future include high-$T_c$ superconductivity and various topological phases.

Below I list general ideas for potential projects. _These projects are only indicative examples of my research interests, and I anticipate refining or expanding them in close interaction with anyone interested, provided they align with my broader scientific interests mentioned above_.
#balance(columns(2, [
