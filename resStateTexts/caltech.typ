...
#balance(
  columns(2, [I am a quantum condensed matter theorist focusing primarily on characterising phases of strongly correlated *quantum matter*. These are novel states that appear at zero temperature and display emergent exotic properties, often driven by strong interactions between the constituent particles. Such phases are interesting because they cannot be described within the paradigm of spontaneous symmetry breaking and local order parameters. Instead, phase transitions involving such phases often involve changes in *topology*.
    ...
    One of the important diagnostics of Kondo breakdown that we have identified is the *thermalisation* of the correlated impurity orbital with the non-interacting sea. In ongoing work, we are exploring how the rate of impurity dynamics thermalisation (or its breakdown) can serve as a probe of quantum criticality. This resonates well with the work of *Prof. Olexei I. Motrunich* at the Walter Burke Institute for Theoretical Physics, Caltech, who investigates the absence of thermalisation in isolated finite-energy states (many-body scars) in interacting systems. I believe this conceptual overlap opens exciting opportunities for fresh collaborative research in the field of eigenstate thermalisation, in the context of quantum impurity models.
])
)
...
In addition to extending my current work on Mott physics and Kondo breakdown, I envision several near-term projects that overlap with ongoing research at Caltech, particularly with the work of *Prof. Olexei I. Motrunich*.
