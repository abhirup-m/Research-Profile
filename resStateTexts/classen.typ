...
I have been following your recent works on instabilities in altermagnetic materials and effect of interactions in bilayer graphene. Given my experience in correlated electronic models and entanglement calculations, I envisage several avenues for our collaboration. These include (i) extending your work "Van-Hove singularities and competing instabilities in an altermagnetic metal" by studying changes in entanglement patterns, and (ii) an alternative angle of attacking the problem of MATBG: electronic interactions in the form of the exactly solvable Hatsugai-Kohmoto model. These ideas are elaborated in more detail in the #link(<projects>)[short-term projects section]. But before that, I describe some of my research in more detail.
]))
...
= Short-term research goals<projects>

#balance(columns(2, [
*Studying entanglement patterns in altermagnets using the parquet RG method*. In your recent preprint arXiv:2505.02786, you studied the tendencies towards altermagnetic instability on a square lattice, using the parquet RG (pRG). I was thinking that since the reduced density matrix (RDM) of a subsystem can be expressed as a matrix of all equal-time correlation functions within that subsystem, we can use the pRG method to evaluate these correlation functions and hence the RDM. This would allow us to explore changes in entanglement patterns arising as a result of altermagnetic instabilities.

*Studying effect of electronic correlations in MATBG through an exactly solvable model*. The Hatsugai-Kohmoto model is an exactly solvable model of correlated electrons, displaying non-Fermi liquid excitations, fermi arcs and unconventional superconductivity. It might be interestin to replace the Hubbard interaction with MATBG with the HK interaction and study the resulting phases thoroughly by making use of the analytic solvability. This therefore provides an interesting route to studying the emergence of novel phases in a correlated MATBG system. Instabilities towards non-BCS superconductivity can also be explored and compared against experiments.
