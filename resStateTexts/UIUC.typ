...
Among the faculty members at UIUC, I have been closely following the work of *Prof. Philip W Phillips* on Mottness, generalised anomalies and unparticles in strongly-correlated quantum matter, in particular the body of research that focuses on the Hatsugai-Kohmoto model. My own research is along similar lines, exploring similar phenomena from the perspective of quantum impurity models. I believe this overlap in our research directions can lead to meaningful collaboration.

Given my experience with renormalisation group methods, numerical computation of correlation functions and exploration of entanglement measures in various interacting models, I envision several interesting lines of research, such as (i) using the HK model to study the physics of magic-angle TBG, (ii) investigating Luttinger theorem violation in heavy-fermion materials, and (iii) looking for manybody scars in HK-type models. I explain these ideas in more detail below. 
]))
...
#balance(
  columns(2, [
    As I have mentioned in the introduction, there is considerable overlap between my research and the work of *Prof. Philip W Phillips* at UIUC. I now describe fresh ideas for projects that can lead to interesting collaborations:
