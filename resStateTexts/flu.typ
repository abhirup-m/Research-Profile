...
One of the most exciting insights that has emerged from this body of work is that in lattice models, correlation-driven transitions must involve an intervening quantum critical phase with long-range entanglement and correlations. We believe this hold true for Mott systems as well as heavy-fermion systems. This resonates well with the work of *Prof. Oskar Vafek* at FSU, who works on, among various other things, magic-angle TBG by employing the relatively recently proposed topologicla heavy-fermion approach. Combining my expertise and experience with Prof. Vafek's interests, I have proposed a number of potential collaborative projects near the end of my research statement.
])
)
...
#figure(
  ...
  caption: [In [@mukherjee2025], we define a lattice-embedded impurity model (guided by phenomenology) and obtain its low-energy phases (top row) using an impurity solver. Using manybody translation operators and Bloch's theorem, we map the phases of the impurity model to those of a lattice model.],
)<Fig1>
...
In addition to extending my current work on Mott physics and Kondo breakdown, I envision several near-term projects that overlap with ongoing research at FSU, particularly with the work of *Prof. Oskar Vafek*.

#balance(
columns(2,
[*Applying the THF framework to Transition Metal Dichalcogenides (TMDs)*. One can apply the topologicla havey fermion approach to study moiré bands in twisted transition metal dichalcogenide homobilayers (Nat Commun 12, 6730 (2021)). Existing work predicts a Haldane insulator to Mott insulator transition af half-filling. Details of the nature of the transition can be probed using this method. 

*Entanglement calculations within the Topological Heavy Fermion (THF) framework*. The THF approach to MATBG can be enhanced by extending it to calculate entanglement measures. This can lead to insights on correlations within as well as between the f and c-electrons. It may also be possible to use it to better characterise the interacting Hofstadter states obtained in the experiments of Nat. Phys. 21, 1380–1386 (2025).
